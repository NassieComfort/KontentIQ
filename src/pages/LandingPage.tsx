    ...
    <div className="min-h-screen bg-[#050510] text-white overflow-x-hidden">
        ...
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            ...
            <button onClick={() => navigate('/signup')}
              className="text-sm bg-linear-to-r from-violet-600 to-purple-600 hover:from-violet-500 hover:to-purple-500 text-white px-5 py-2 rounded-xl font-semibold transition-all shadow-lg shadow-violet-500/25 hover:-translate-y-0.5">
              Get Started Free
            </button>
          </div>
        </div>
      ...
      <section className="relative min-h-screen flex items-center justify-center pt-20 overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-5xl mx-auto px-6 space-y-8">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <button onClick={() => navigate('/signup')}
              className="group flex items-center gap-2 bg-linear-to-r from-violet-600 to-purple-600 hover:from-violet-500 hover:to-purple-500 text-white px-8 py-4 rounded-2xl text-lg font-semibold transition-all shadow-2xl shadow-violet-500/30 hover:-translate-y-1">
              Start for Free
        ...
        <div className="max-w-5xl mx-auto px-6 grid grid-cols-2 md:grid-cols-4 gap-8">
          {stats.map((s, i) => (
            <div key={i} className="text-center space-y-1">
              <div className="text-4xl font-bold bg-linear-to-r from-violet-400 to-cyan-400 bg-clip-text text-transparent">{s.value}</div>
      ...
      <section id="features" className="max-w-7xl mx-auto px-6 py-28">
        <div className="text-center mb-16 space-y-4">
          <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 text-slate-400 text-xs font-medium uppercase tracking-wider">Features</div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((f, i) => (
            <div key={i} className="group relative p-6 rounded-3xl border border-white/5 bg-white/3 hover:bg-white/6 hover:border-white/10 transition-all duration-300 hover:-translate-y-1 overflow-hidden">
              <div className={`absolute inset-0 bg-linear-to-br ${f.color} opacity-0 group-hover:opacity-5 transition-opacity rounded-3xl`} />
              <div className={`w-12 h-12 rounded-2xl bg-linear-to-br ${f.color} flex items-center justify-center mb-4 shadow-lg`}>
      ...
      <section id="how" className="py-28 relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-16 space-y-4">
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full border border-white/10 bg-white/5 text-slate-400 text-xs font-medium uppercase tracking-wider">How it works</div>
            <h2 className="text-4xl md:text-5xl font-bold">From brand to content in minutes</h2>
          </div>
          <div className="grid md:grid-cols-3 gap-8 relative">
            <div className="hidden md:block absolute top-8 left-1/3 right-1/3 h-px bg-linear-to-r from-violet-500/50 to-cyan-500/50" />
            {[
              ...
              <div key={i} className="text-center space-y-4 relative">
                <div className="w-16 h-16 rounded-2xl bg-linear-to-br from-violet-600/20 to-purple-600/20 border border-violet-500/20 flex items-center justify-center mx-auto">
      ...
      <section className="max-w-4xl mx-auto px-6 py-20">
        <div className="relative rounded-3xl overflow-hidden p-12 text-center border border-violet-500/20">
          <div className="absolute inset-0 bg-linear-to-br from-violet-900/40 via-purple-900/30 to-slate-900/40" />
          <div className="absolute top-0 left-1/2 -translate-x-1/2 w-64 h-px bg-linear-to-r from-transparent via-violet-500 to-transparent" />
          <div className="relative z-10 space-y-6">
            <h2 className="text-4xl font-bold">Ready to scale your content?</h2>
            <p className="text-slate-400 text-lg max-w-xl mx-auto">Join brands already using KontentIQ to generate on-brand content at scale.</p>
            ...
            <button onClick={() => navigate('/signup')}
              className="inline-flex items-center gap-2 bg-linear-to-r from-violet-600 to-purple-600 hover:from-violet-500 hover:to-purple-500 text-white px-10 py-4 rounded-2xl text-lg font-semibold transition-all shadow-2xl shadow-violet-500/30 hover:-translate-y-1">
